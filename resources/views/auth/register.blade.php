    ...
    <div class="card-body p-0">
        ...
        <div class="row">
            <div class="col-lg-5 d-flex align-items-center">
                <img src="{{ asset('img/logo-img.jpg') }}" alt="" class="img-fluid">
            </div>
                ...
                <div class="p-5">
                    ...
                    <form class="user" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <input id="name" type="text" class="form-control form-control-user " name="name" value="{{ old('name') }}" required autocomplete="name" required autocomplete="name" placeholder="Name" autofocus>
                            @error('name')
